...
Versão 0.0.6 implementa:

types: int, callable(a function type), bool, char, void, pointer(T*)
expressions: constant(int, bool, char), identifier, binary, call, implicit_cast, assignment, conditional, unary(address-of &, dereference *)
statement: return(with value), block, if, var(declare variable), act(like function call ou assign variable)
declaration: function, argument, variable
